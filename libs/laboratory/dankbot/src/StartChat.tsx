...
export function StartChat() {
  const welcomeMessage = `
    ...
    No worries - I'm glad you're here. Allow myself to introduce... myself. I'm DankBot. Your friendly neighborhood UI.
  ...
  return (
    <form className="h-full flex flex-col" action={startChat}>
      <div>
